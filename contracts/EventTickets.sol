...
contract EventTickets {
    ...
    */
    function getBuyerTicketCount(address customer)
        public
        view
        returns (uint) {
            return myEvent.buyers[customer];
    }
    ...
    */
    ...
    payable
        ...
        require(myEvent.sales + tickets <= myEvent.totalTickets, "Not enough tickets in stock.");
        uint totalCost = TICKET_PRICE * tickets;
