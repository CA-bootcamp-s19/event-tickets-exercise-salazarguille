...
contract EventTicketsV2 {
    ...
    */
    ...
    payable
        ...
        require(anEvent.isOpen, "Event must be opened.");
        require(anEvent.sales + tickets <= anEvent.totalTickets, "Not enough tickets in stock.");
        uint totalCost = PRICE_TICKET * tickets;
        require( msg.value >= totalCost, "Ether sent is not enough to pay tickets.");

        anEvent.buyers[msg.sender] += tickets;
        anEvent.sales += tickets;
